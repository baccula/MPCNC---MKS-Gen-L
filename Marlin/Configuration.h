...
#define CUSTOM_MACHINE_NAME "MikePCNC"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100, 100, 200, 100 }
...
//
#define REVERSE_ENCODER_DIRECTION //MCN should have used this instead of the PINs file.
